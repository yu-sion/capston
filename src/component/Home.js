...
export default function Home(props){
    ...
    */
    ...
    // const [userList, setUserList]      = useState(null);        // 유저 목록
    ...
    // const waitStd = async () => {
    //     const url = serverUrl.StdPermit + clickEvent.subjectClick;
    //     console.log(clickEvent.subjectClick);
    //     console.log(url);
   ...
   const infoChangeFunc = () => {
    ...
    //     if(userData.userType == "professor" && ( optionState != 1 || key != clickEvent.subjectClick)){
    //         console.log("??");
    ...
    // const StdPermit = async (subject, key) => {
    //     await waitStd();
    //     console.log(userList);
    //     const lists_1 = userList == null ? null : userList.map(list => {
    //         if(list.includeClass == "0"){
    //             return (
    ...
    //     const lists_2 = userList == null ? null : userList.map( list => {
    ...
    //                 => 수업중X : 자료실, 녹화보기, 질문
    //         */
    //         const view = userData.userType == "professor" ? 
